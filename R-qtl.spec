...
Version  : 1.54
Release  : 42
URL      : https://cran.r-project.org/src/contrib/qtl_1.54.tar.gz
Source0  : https://cran.r-project.org/src/contrib/qtl_1.54.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670504143
