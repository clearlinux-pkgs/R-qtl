...
Version  : 1.70
Release  : 53
URL      : https://cran.r-project.org/src/contrib/qtl_1.70.tar.gz
Source0  : https://cran.r-project.org/src/contrib/qtl_1.70.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724303550
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/qtl/libs/qtl.so
/V4/usr/lib64/R/library/qtl/libs/qtl.so
