...
Version  : 1.42.8
Release  : 3
URL      : https://cran.r-project.org/src/contrib/qtl_1.42-8.tar.gz
Source0  : https://cran.r-project.org/src/contrib/qtl_1.42-8.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1530404092
...
/usr/lib64/R/library/qtl/README.md
/usr/lib64/R/library/qtl/STATUS.txt
